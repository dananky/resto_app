...
class Master extends CI_Controller {
    ...
    public function ingredientCategories() {
        ...
        $data = array();
         // menu setting
        $data['master_menu'] = 'master';
        $data['sub_menu'] = 'ingredient_categorie';
    ...
    public function foodMenuCategories() {
        ...
        // menu setting
        $data['master_menu'] = 'master';
        $data['sub_menu'] = 'food_menu_categorie';
