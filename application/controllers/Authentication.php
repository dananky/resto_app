    ...
    public function changePassword() {
        ...
        if ($this->input->post('submit') == 'submit') {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $data = array();
                // menu setting
                $data['master_menu'] = 'change_passwords';
                $data['sub_menu'] = '';
            ...
            $data = array();
             // menu setting
                $data['master_menu'] = 'setting';
                $data['sub_menu'] = 'change_passwords';
