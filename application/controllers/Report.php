...
class Report extends CI_Controller {
    ...
    public function printDailySummaryReport($selectedDate = ''){
        $data = array(); 
         // menu setting
        $data['master_menu'] = 'reports';
        $data['sub_menu'] = 'dailysummaryreports';
    ...
    public function dailyConsumptionReport() {
        $data = array();
         // menu setting
        $data['master_menu'] = 'reports';
        $data['sub_menu'] = 'dailyconsumptionreports';
    ...
    public function inventoryReport() {
        ...
        // menu setting
        $data['master_menu'] = 'reports';
        $data['sub_menu'] = 'inventory_reports';
    ...
    public function saleReportByDate() {
        ...
        // menu setting
        $data['master_menu'] = 'reports';
        $data['sub_menu'] = 'daily_sale_reports';
    ...
    public function profitLossReport() {
        ...
        // menu setting
        $data['master_menu'] = 'reports';
        $data['sub_menu'] = 'profit_loss_reports';
    ...
    public function supplierReport() {
        ...
        // menu setting
        $data['master_menu'] = 'reports';
        $data['sub_menu'] = 'supplier_ledgers';
    ...
    public function customerReport() {
        ...
        // menu setting
        $data['master_menu'] = 'reports';
        $data['sub_menu'] = 'customer_ledgers';
    ...
    public function consumptionReport() {
        ...
        // menu setting
        $data['master_menu'] = 'reports';
        $data['sub_menu'] = 'consumption_reports';
    ...
    public function detailedSaleReport() {
        ...
        // menu setting
        $data['master_menu'] = 'reports';
        $data['sub_menu'] = 'detailed_sale_reports';
    ...
    public function purchaseReportByDate() {
        ...
        // menu setting
        $data['master_menu'] = 'reports';
        $data['sub_menu'] = 'purchase_reports';
    ...
    public function kitchenPerformanceReport() {
        ...
        // menu setting
        $data['master_menu'] = 'reports';
        $data['sub_menu'] = 'kitchen_performance_reports';
    ...
    public function supplierDueReport() {
        ...
        // menu setting
        $data['master_menu'] = 'reports';
        $data['sub_menu'] = 'supplier_due_reports';
    ...
    public function customerDueReport() {
        ...
        // menu setting
        $data['master_menu'] = 'reports';
        $data['sub_menu'] = 'customer_due_report';
    ...
    public function getInventoryAlertList() {
        ...
        // menu setting
        $data['master_menu'] = 'reports';
        $data['sub_menu'] = 'low_inventory_reports';
    ...
    public function attendanceReport() {
        ...
        // menu setting
        $data['master_menu'] = 'reports';
        $data['sub_menu'] = 'attendance_reports';
