...
// dddddddddddddddddddddddddddddddddddddddddddddddddddd
    ...
    public function top_ten_food_menu($start_date, $end_date) {
        $outlet_id = $this->session->userdata('outlet_id');
        $this->db->select('sum(tbl_sales_details.qty) as totalQty, tbl_sales_details.food_menu_id, tbl_sales_details.menu_name, tbl_sales.sale_date');
        $this->db->from('tbl_sales_details');
        $this->db->join('tbl_sales', 'tbl_sales.id = tbl_sales_details.sales_id', 'left');
        $this->db->where('DATE(tbl_sales.sale_date) >=', $start_date);
        $this->db->where('DATE(tbl_sales.sale_date) <=', $end_date); 
