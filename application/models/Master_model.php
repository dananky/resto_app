...
class Master_model extends CI_Model {
    ...
    public function getIngredientListWithUnit($company_id) {
        $result = $this->db->query("SELECT tbl_ingredients.id, tbl_ingredients.name, tbl_ingredients.code, tbl_units.unit_name, tbl_ingredients.purchase_price 
    ...
    public function getPriceIngredients($id) {
        $this->db->select("*");
