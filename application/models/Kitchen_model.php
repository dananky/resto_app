...
class Kitchen_model extends CI_Model {
    ...
    public function print_kitchen($previous_id){
      $this->db->select('tbl_sales.sale_date, tbl_sales_details.sales_id, tbl_sales.order_time, tbl_sales.sale_no, tbl_sales_details.menu_name, tbl_sales_details.qty, tbl_sales_details.menu_unit_price, tbl_customers.name AS customer_name');
      $this->db->from('tbl_sales_details');
      $this->db->join('tbl_sales', 'tbl_sales.id = tbl_sales_details.sales_id', 'left');
      $this->db->join('tbl_customers', 'tbl_customers.id = tbl_sales.customer_id', 'left');
      $this->db->where("tbl_sales_details.previous_id", $previous_id);
