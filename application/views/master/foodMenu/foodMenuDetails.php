                                        ...
                                        if ($food_menu_ingredients && !empty($food_menu_ingredients)) {
                                            foreach ($food_menu_ingredients as $fmi) {
                                                ...
                                                if($ingredients_name =="Air Galon 19Lt"){
                                                    $ingredients_price=($fmi->consumption/19000)*getPriceIngredients($fmi->ingredient_id);
                                                }else{
                                                    $ingredients_price=getPriceIngredients($fmi->ingredient_id)*($fmi->consumption);
                                                }
                                                echo "<tr>" .
                                                ...
                                                "<td style='width: 25%'>" . $fmi->consumption . " " . unitName(getUnitIdByIgId($fmi->ingredient_id)) . "</td>" .
                                                "<td style='width: 20%'>" . $ingredients_price . "</td>" .
                                                "</tr>";
                                                array_push($total,$ingredients_price);
                                            }
                                            echo'<tr style="background-color:#ecf0f5">
                                                <td colspan="3" style="text-align:right;font-weight:bold;">Total Ingredient Price :</td>
                                                <td colspan="2" style="font-weight:bold;">Rp ' . array_sum($total) .'.00</td>
                                            </tr>';
                                        }
                                        ?>  
                                    </tbody>
