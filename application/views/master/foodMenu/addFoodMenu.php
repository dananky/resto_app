        ...
        $('#ingredient_id').change(function(){
            ...
            if (ingredient_details != '') {
                ...
                var cart_row = '<tr class="rowCount" id="row_' + suffix + '">'+
                    ...
                    '<td style="width: 30%"><input type="text" tabindex="'+ tab_index +'" id="consumption_' + suffix + '" name="consumption[]" onfocus="this.select();"  class="consumption form-control integerchk aligning" style="width: 85%;" placeholder="<?php echo lang('consumption'); ?>"/><span class="label_aligning">' + ingredient_details_array[2] + '</span></td>'+
                            ...
                            <div class="form-group"> 
                                ...
                                <select tabindex="5" class="form-control select2 select2-hidden-accessible" name="ingredient_id" id="ingredient_id" style="width: 100%;">
                                    ...
                                    <?php foreach ($ingredients as $ingnts) { ?>
                                        <option value="<?php echo $ingnts->id . "|" . $ingnts->name . "|" . $ingnts->unit_name . "|" . $ingnts->purchase_price ?>" <?php echo set_select('unit_id', $ingnts->id); ?>><?php echo $ingnts->name . "(" . $ingnts->code . ")"; ?></option>
                                    <?php } ?>
                                </select>
                            </div>  
