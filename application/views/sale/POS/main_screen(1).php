...
$i = 1;
$category_slide_to_show = '';
// $category_slide_to_show = '<option class="category_button" id="button_category_show" style="border-left: solid 2px #DEDEDE;">All</option>';

foreach($menu_categories as $single_category){
    if($i = 1){
        $category_slide_to_show .= '<option class="category_button" id="button_category_'.$single_category->id.'">'.$single_category->category_name.'</option>';
...
<html>
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        <title>Manager Of Business | PT. Kreasi Digital Indonesia</title>
        ...
        <div class="wrapper fix">
            <div class="top_header_part fix">
                <div class="header_part_left_left fix">
                    ...
                    <!--    </div>-->
                    <!--</div>-->
                    <button onclick="openNav()" id="btn-runningorder" style="font-size:15px;margin-bottom:10px;background-color:#6D91F0;color:white;border:none;height: 50px;">
                        <span> <strong>&#62;</strong> Running Orders</span>
                    </button>
                </div>
                ...
                <div class="header_part_right fix">
                    <div class="header_single_button_holder" style="width:21%">
                        <button style="float:left;" id="last_ten_sales_button"><i class="fas fa-history"></i> <?php echo lang('last_ten_sales'); ?></button>
                    </div>
                    <div style="text-align:center;width:23%" class="header_single_button_holder">
            ...
            <div id="mySidenav" class="sidenav">
                ...
                <div class="main_left fix" style="margin-right: 5px">
                    <div class="holder fix">
                        <div id="running_order_header">
                            ...
                            <input type="text" name="search_running_orders" id="search_running_orders" style="height: 15px;    margin: 0px 0px 0px 5px;width: 91%;" placeholder="<?php echo lang('customer_waiter_order_table'); ?>" />
                        </div>

                        <div class="order_details fix" id="order_details_holder">
                            <?php echo $order_list_left; ?>
                        </div>
                        <div style="position: absolute;bottom: 0px;width:100%;" id="left_side_button_holder_absolute">
            ...
            <div id="main" onclick="closeNav()" style="margin-left: 320px">
                ...
                <div class="main_middle fix" id="main_middle">
                    <div class="main_top fix">
                        <div class="button_holder fix">
                            <div class="single_button_middle_holder fix">
                                <button data-selected="unselected" style="float:left;margin-left:2px;" id="dine_in_button" class="dine_in"><i class="fas fa-table"></i> <?php echo lang('dine'); ?></button>
                            </div>
                            <div style="text-align:center;" class="single_button_middle_holder fix">
                                <button id="take_away_button" class="take_away"><i class="fas fa-shopping-bag"></i> <?php echo lang('take_away'); ?></button>
                            </div>
                            <div class="single_button_middle_holder fix">
                                <button class="delivey_order" style="float:right;margin-right:2px;" id="delivery_button" class="delivery"><i class="fas fa-truck"></i> <?php echo lang('delivery'); ?></button>
                            </div>

                        </div>
                        <div class="waiter_customer">
                            <div class="single_button_middle_holder" style="padding-left:.4%;width:32.9%;height: 33px;">
                                <select style="width:92%;margin-left:2px;background-color:#ffffff;height: 100%;" id="select_waiter" disabled>
                                    <option value="<?php echo $this->session->userdata['user_id'] ?>"><?php echo $this->session->userdata('full_name'); ?></option>
                                </select>
                                <!--<input style="width:92%;margin-left:2px;" id="select_waiter" value="<?php echo $this->session->userdata['user_id']?>" disabled>-->
                                <!--<p style="width:92%;margin-left:2px;border: 1px solid #b6b6b3" id="select_waiter" value="<?php echo $this->session->userdata['user_id']?>"><?php echo $this->session->userdata('full_name'); ?></p>-->
                            </div>
                            <div class="single_button_middle_holder">
                                <div style="width:92%;margin:0 auto;height: 100%;">
                                    <select id="walk_in_customer" id="select_walk_in_customer" class="select2" style="height: 100%;">
                                    ...
                                    <i class="fas fa-plus-square" id="plus_button"></i>
                                </div>
                            </div>
                            <div class="single_button_middle_holder">
                                <button id="table_button" class="table_button"><i class="fas fa-table"></i> <?php echo lang('table'); ?></button>
                            </div>
                        </div>
                        <!-- <select>
                                <option>Table</option>
                    ...
                    <div style="position: absolute;bottom: 1px;width: 100%" id="bottom_absolute">
                        ...
                        <table cellspacing="0" cellpadding="0">
                                <tr style="background-color: #ffffff;">
                                    <th style="width:40%;text-align:left;padding-left:10px">&nbsp;</th>
                                    <th style="width:10%;">&nbsp;</th>
                                    <th style="width:15%;">&nbsp;</th>
                                    <th style="width:10%;">&nbsp;</th>
                                    <th style="width:25%;text-align:right;padding-right:10px;">&nbsp;</th>
                                </tr>
                                ...
                                <tr style="background-color:#F5F5F5;">
                                    <td></td>
                                    <td style="font-weight:bold;text-align:right;" colspan="3"><?php echo ('All discount'); ?>
                                    </td>
                                    <td style="text-align:right;padding-right:10px;">
                                      <!-- <span id="all_items_discount">0.00</span> -->
                                      <input type="text" class="special_textbox" id="sub_total_discount" disabled/>
                                      <i style="cursor:pointer;" class="fa fa-tags edit_all_diskon" id="edit_all_diskon"></i></td>
                                </tr>
                                <!--<tr style="background-color:#F5F5F5;">-->
                                <!--     <td></td>-->
                                ...
                                <tr id="delivery_change2" style="background-color:#F5F5F5;">
                                    <td></td>
                                    <td style="font-weight:bold;text-align:right;" colspan="3"><?php echo lang('delivery_charge'); ?></td>
                                    <td style="text-align:right;padding-right:10px;">
                                    <input type="text" name="" value="10" class="special_textbox" placeholder="Amt" id="delivery_charge" disabled/></td>
                                </tr>
                                <tr style="background-color:#F5F5F5;">
                                    <td></td>
                                    <td style="font-weight:bold;text-align:right;" colspan="3"><?php echo lang('delivery'); ?></td>
                                    <td style="text-align:right;padding-right:10px;">
                                    <input type="text" class="special_textbox" value="" id="delivery_order" disabled>

                                    <!-- <span id="delivery_order">0.00</span> -->
                                </td>
                                </tr>
                                <tr style="background-color:#F5F5F5;">
                                    <td></td>
                                    <td style="font-weight:bold;text-align:right;" colspan="3"><?php echo ('Tax'); ?></td>
                                    <td style="text-align:right;padding-right:10px;">
                                    <input type="text" disabled name="" value="5"  class="special_textbox" placeholder="Amt" id="tax_charge" disabled/>
                                    </td>
                                </tr>
                                <tr style="background-color: #FEBF11;height: 35px;">
                                    <td></td>
                                    <td style="font-weight:bold;text-align:right;color: black;" colspan="3"><?php echo lang('total_payable'); ?></td>
                                    <td style="font-weight:bold;text-align:right;padding-right:10px;color: black;"><?php echo $this->session->userdata('currency'); ?> <span id="total_payable">0.00</span></td>
                                </tr>
                            </table>
                        <div class="main_bottom fix" style="padding-top:2px;">
                            <div class="button_group fix">
                                <div class="single_button_middle_holder cart_bottom_buttons" style="width:17%;">
                                    <button style="float:left;padding:0px 3px;" id="cancel_butt                                    <button id="hold_sale" style="padding:0px 3px;"><i class="fas fa-hand-rock"></i></i> <?php echo lang('hold'); ?></button>
on"><i class="fas fa-times"></i> <?php echo lang('cancel'); ?></button>
                                </div>
                                ...
                                <div class="single_button_middle_holder cart_bottom_buttons" style="width:34%;border:none">
                ...
                <div class="main_right fix">
                    ...
                    <div class="select_category fix">
                        ...
                        <!--<div class="select_category_inside">-->
                            <div class="select_category_inside_inside" style="width: 100%">
                                <select data-native-menu="false" style="width: 100%" class="select2" id="category_select">
                                    <!--<option class="category_button" id="button_category_show_all">All</option>-->
                                    <?php echo $category_slide_to_show; ?>
                                </select>
                            </div>
        ...
        <div id="item_modal_diskon" class="modal">
<div class="modal-content">  
...
<table id="diskon">
  <tr>
    ...
    <th>Action</th>
        ...
        <?php
        foreach($menu_discount as $row)
        {
            echo "<tr>";
            echo "<td>".$row->discount_name."</td>";
            echo "<td>".$row->price."</td>";
            echo "<td>" .$row->amount."</td>";
            echo "<td> <button data-amount=".$row->amount."  data-price=".$row->price." id='modal_discount'> add </td>";
            echo "</tr>";
        }
        ?>
        </table>
        <br><br>
        <div class="diskon_button"> 
            <button id="close"> close </div>
         </div>
      </div>                  
    </div>
    <div id="item_all_diskon" class="modal">
        <div class="modal-content">                 
        <span id="modal_item_row" style="display:none">0</span>
        <span id="modal_item_id" style="display:none"></span>
        <span id="modal_item_price" style="display:none"></span>
        ...
        <table id="diskon">
          <tr>
            ...
            <th>Action</th>
                ...
                <?php
                foreach($menu_discount_allitem as $row)
                {
                    echo "<tr>";
                    echo "<td>".$row->discount_name."</td>";
                    echo "<td>".$row->price."</td>";
                    echo "<td>" .$row->amount."</td>";
                    echo "<td> <button data-amount=".$row->amount." data-price=".$row->price." id='modal_all_discount'> add </td>";
                    echo "</tr>";
                }
                ?>
                </table>
        ...
        <div id="item_modal_delivery" class="modal">
        <div class="modal-content">                                   
        <div class="modal-header">
             Delivery Order
        </div>
        ...
        <table id="diskon">
          <tr>
            ...
            <th>Action</th>
                ...
                <?php
                foreach($menu_delivery as $row)
                {
                    echo "<tr>";
                    echo "<td>".$row->name_delivery."</td>";
                    echo "<td>".$row->price_delivery."</td>";
                    echo "<td> <button data-price=".$row->price_delivery." id='modal_delivery'> add </td>";
                    echo "</tr>";
                }
                ?>
                </table>
                <br><br>
                <div class="diskon_button"> 
                    <button id="close_delivery"> close </div>
                 </div>
              </div>                  
            </div>
         <!--add customer modal -->
                        ...
                        <div class="hold_sale_right fix">
                            <div class="top fix">
                                <div class="top_middle fix">
                                    ...
                                    <div class="item_modifier_details fix" style="overflow-y: auto;">
                                        ...
                                        <div class="bottom_total_calculation_hold ">
                                            <div class="single_row first ">
                                                <div class="first_column "><?php echo lang('total_item'); ?>: <span id="total_items_in_cart_hold">0</span></div>
                                                <div class="second_column "><?php echo lang('sub_total'); ?></div>
                                                <div class="third_column "><?php echo $this->session->userdata('currency'); ?> <span id="sub_total_show_hold">0.00</span>
                                            ...
                                            <div class="first_column fix"><?php echo ('All discount'); ?></div>
                                                <div class="second_column fix"><input type="text" name="" placeholder="Amt or %" class="special_textbox" id="sub_total_discount"  disabled>
                                                <i style="cursor:pointer;" class="fa fa-tags edit_all_diskon" id="edit_all_diskon"></i>
                                                </div>
                                            </div>
                                            <div class="single_row third fix">
                                                <!-- <div class="first_column fix">VAT</div> -->
                                                <div class="second_column fix"  colspan="5" style="width:100%;"><span id="all_items_vat_hold" style="display: block;overflow: auto;height: 20px;">0.00</span></div>
                                            </div>
                                            <div class="single_row forth fix">
                                                <div class="first_column fix"><?php echo lang('total_discount'); ?></div>
                                                <div class="second_column fix"><?php echo $this->session->userdata('currency'); ?> <span id="sub_total_discount_hold">0.00</span></div>
                                            </div>
                                ...
                                <div class="top_middle fix">
                                    ...
                                    <div class="item_modifier_details fix">
                                        ...
                                        <div class="bottom_total_calculation_hold fix">
                                            ...
                                            <div class="single_row second fix">
                                            <div class="first_column fix"><?php echo ('All discount'); ?></div>
                                                <div class="second_column fix">
                                                    <input type="text" name="" placeholder="Amt or %" class="special_textbox" 
                                                    id="sub_total_discount" disabled>
                                                    <i style="cursor:pointer;" class="fa fa-tags edit_all_diskon" id="edit_all_diskon"></i>
                                                </div>
                                            </div>
                                            <div class="single_row third fix">
                                                <!-- <div class="first_column fix">VAT</div> -->
                                                <div class="second_column fix"  colspan="5" style="width:100%;"><span id="all_items_vat_last_10"style="display: block;overflow: auto;height: 20px;"></span></div>
                                            </div>
                                            <div class="single_row forth fix">
                                                <div class="first_column fix"><?php echo lang('total_discount'); ?></div>
                                                <div class="second_column fix"><?php echo $this->session->userdata('currency'); ?> <span id="sub_total_discount_last_10">0.00</span></div>
                                            </div>
                                            <div class="single_row fifth fix">
                                                <div class="first_column fix"><?php echo lang('delivery_charge'); ?></div>
                        ...
                        <div class="top_middle fix">
                            ...
                            <div class="item_modifier_details fix">
                                ...
                                <div class="bottom_total_calculation_hold fix">
                                    ...
                                    <div class="single_row third fix">
                                        <!-- <div class="first_column fix">VAT</div> -->
                                        <div class="second_column fix"  colspan="5" style="width:100%;"><span id="all_items_vat_order_details"  style="display: block;overflow: auto;height: 20px;">0.00</span></div>
                                    </div>
                                    <div class="single_row forth fix">
                                        <div class="first_column fix"><?php echo lang('total_discount'); ?></div>
        ...
        <!--        <table style="margin:10px;width:330px;">-->
        <!--            <tr style="height:50px;">-->
        <!--                <td><?php echo lang('total_payment'); ?></td>-->
        <!--                <td>:</td>-->
        <!--                <td><?php echo $this->session->userdata('currency');?> <span id="finalize_total_payable">0.00</span></td>-->
        <!--            </tr>-->
        <!--            <tr style="height:50px;">-->
        <!--                <td>Type Payment</td>-->
        <!--                <td>:</td>-->
        <!--                <td style="height:40px;">-->
        <!--                        <select style="height: 100%;width: 210px;border: 1px solid #b6b6b3;border-radius:3px;" name="finalie_order_payment_method" id="finalie_order_payment_method">-->
        ...
        <!--                <td>:</td>-->
        <!--                <td><input type="number" name="pay_amount_invoice_modal_input" id="pay_amount_invoice_input"></td>-->
        <!--            </tr>-->
        <!--            <tr style="height:50px;">-->
        <!--                <td><?php echo lang('due_amount'); ?></td>-->
        <!--                <td>:</td>-->
        <!--                <td><input type="number" name="due_amount_invoice_modal_input" id="due_amount_invoice_input" disabled></td>-->
        <!--            </tr>-->
        <!--            <tr style="height:50px;">-->
        <!--                <td><?php echo lang('given_amount'); ?></td>-->
        <!--                <td>:</td>-->
        <!--                <td><input type="number" name="given_amount_modal_input" id="given_amount_input"></td>-->
        <!--            </tr>-->
        <!--            <tr style="height:50px;">-->
        <!--                <td><?php echo lang('change_amount'); ?></td>-->
        <!--                <td>:</td>-->
        <!--                <td><input type="number" name="change_amount_modal_input" id="change_amount_input" disabled></td>-->
        <!--            </tr>-->
        <!--            <tr style="height:50px;">-->
        <!--                <td><button id="finalize_order_cancel_button"><?php echo lang('cancel'); ?></button></td>-->
        <!--                <td><button id="finalize_order_button"><?php echo lang('submit'); ?></button></td>-->
        <!--            </tr>-->
        <!--        </table>-->
        <!--    </div>-->
        <!--</div>-->
        ...
        <div id="finalize_order_modal" class="modal">
            ...
            <div class="modal-content" id="modal_finalize_order_details">
                <h1 id="modal_finalize_header"><?php echo lang('finalize_order'); ?></h1>
                <table style="margin:15px;width:370px;" id="invoiceForm">
                    <tr style="height:50px;margin:5px;">
                        <td style="width:30%"><span style="display:none;" id="finalize_update_type"></span><?php echo lang('total_payment'); ?></td>
                        <td style="width:5%">:</td>
                        <td style="width:65%"><?php echo $this->session->userdata('currency');?> <span id="finalize_total_payable">0.00</span></td>
                    </tr>
                    <tr style="height:50px;margin:5px;">
                        <td style="width:30%">Type Payment</td>
                        <td style="width:5%">:</td>
                        <td style="width:65%;height:20px">
                            <select name="finalize_order_payment_method" id="finalize_order_payment_method" style="height: 100%;width: 150px;border: 1px solid #b6b6b3;border-radius:3px;">
                                <option value=""><?php echo lang('payment_method'); ?></option>
                                <?php echo $payment_method_options; ?>
                            </select>
                        </td>
                    ...
                    <tr style="height:50px;margin:5px;">
                        <td style="width:30%"><?php echo lang('pay_amount'); ?></td>
                        <td style="width:5%">:</td>
                        <td style="width:65%;height:20px"><input value="" type="text" name="pay_amount_invoice_input" id="pay_amount_invoice_input" style="width:200px;height:100%;padding-left:5px;border: 1px solid #b6b6b3;border-radius:3px;"></td>
                    </tr>
                    <tr style="height:50px;margin:5px;"> 
                        <td style="width:30%"><?php echo lang('due_amount'); ?></td>
                        <td style="width:5%">:</td>
                        <td style="width:65%;height:20px"><input value="" type="text" name="due_amount_invoice_input" id="due_amount_invoice_input" style="width:200px;height:100%;padding-left:5px;border: 1px solid #b6b6b3;border-radius:3px;" disabled></td>
                    </tr>
                    <tr style="height:50px;margin:5px;">
                        <td style="width:30%"><?php echo lang('given_amount'); ?></td>
                        <td style="width:5%">:</td>
                        <td style="width:65%;height:20px"><input value="" type="number" name="given_amount_input" id="given_amount_input" style="width:200px;height:100%;padding-left:5px;border: 1px solid #b6b6b3;border-radius:3px;" onblur="validate()"></td>
                    </tr>
                    <tr style="height:50px;margin:5px;">
                        <td style="width:30%"><?php echo lang('change_amount'); ?></td>
                        <td style="width:5%">:</td>
                        <td style="width:65%;height:20px"><input value="" type="text" name="change_amount_input" id="change_amount_input" style="width:200px;height:100%;padding-left:5px;border: 1px solid #b6b6b3;border-radius:3px;" disabled></td>
                    </tr>
                </table>
                <!--<div class="fo_1 fix">-->
                ...
                <!--</div>-->
                <!--<div class="fo_2 fix">-->
                <!--    <di style="width:65%"v class="half fix floatleft">Type Payment</div>-->
                ...
                <!--     <div class="half fix floatleft textleft"><input type="number" name="given_amount_modal_input" id="given_amount_input"></div>-->
        ...
        <script type="text/javascript">
            ...
            //   document.getElementById("order_details_holder").visible();
