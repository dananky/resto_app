                    ...
                    <div style="position: absolute;bottom: 1px;width: 100%" id="bottom_absolute">
                        ...
                        <table cellspacing="0" cellpadding="0">
                                ...
                                <tr id="delivery_change2" style="background-color:#F5F5F5;">
                                    <td></td>
                                    <td style="font-weight:bold;text-align:right;" colspan="3">Service Charge</td>
                                    <td style="text-align:right;padding-right:10px;">
                                ...
                                <!--    <td style="text-align:right;padding-right:10px;"><input type="number" name="delivery_charge"  class="special_textbox" placeholder="Amt" id="delivery_charge"/></td>-->
                                <!--</tr>-->
