        ...
        <div id="left_menu_to_scroll">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                <?php if (in_array('Dashboard', $this->session->userdata('menu_access'))) { ?> 
                    <li <?php echo ($master_menu == 'dashboard') ? 'class="active"' : ''; ?>>
                ...
                <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php } ?>
                                <?php if (in_array('Sale_waiter', $this->session->userdata('menu_access'))) { ?> 
                                    <li><a href="<?php echo base_url(); ?>Sale_waiter/POS"><i class="fa fa-angle-double-right"></i><?php echo lang('sale_waiter'); ?></a></li> 
                                <?php } ?>
                            </ul>
                        </li>
                    <?php } ?>
                            ...
                            <?php if (in_array('Inventory', $this->session->userdata('menu_access'))) { ?> 
                                <li <?php echo ($master_menu == 'inventory') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo base_url(); ?>Inventory/index"><i class="fa fa-hdd-o"></i> <span><?php echo lang('inventory'); ?></span></a>
                                </li>

                                <?php if (in_array('Inventory', $this->session->userdata('menu_access'))) { ?> 
                                <li <?php echo ($master_menu == 'discount') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo base_url(); ?>Discount/discount"><i class="fa fa-hdd-o"></i> <span><?php echo lang('discount'); ?></span></a>
                                </li>
                            ...
                            <?php if (in_array('Inventory_adjustment', $this->session->userdata('menu_access'))) { ?>
                                <li <?php echo ($master_menu == 'adjustment') ? 'class="active"' : ''; ?>>
                            ...
                            <?php if (in_array('Waste', $this->session->userdata('menu_access'))) { ?> 
                                <li <?php echo ($master_menu == 'wastes') ? 'class="active"' : ''; ?>>
                            ...
                            <?php if (in_array('Expense', $this->session->userdata('menu_access'))) { ?> 
                                <li <?php echo ($master_menu == 'expenses') ? 'class="active"' : ''; ?>>
                            ...
                            <?php if (in_array('SupplierPayment', $this->session->userdata('menu_access'))) { ?> 
                                <li <?php echo ($master_menu == 'supplierpayment') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo base_url(); ?>SupplierPayment/supplierPayments"><i class="fa fa-money"></i> <span><?php echo lang('supplier_due_payments'); ?></span></a>
                                </li> 
                            <?php } ?>
                            <?php if (in_array('Customer_due_receive', $this->session->userdata('menu_access'))) { ?> 
                                <li <?php echo ($master_menu == 'customer_due_receives') ? 'class="active"' : ''; ?>>
                            ...
                            <?php if (in_array('Attendance', $this->session->userdata('menu_access'))) { ?> 
                                <li <?php echo ($master_menu == 'attendances') ? 'class="active"' : ''; ?>>
                            ...
                            <?php if (in_array('Report', $this->session->userdata('menu_access'))) { ?> 
                                <li class="treeview <?php echo ($master_menu == 'reports') ? 'active' : ''; ?>">
                                    <a href="#">
                                    ...
                                    <ul class="treeview-menu">
                                        <li <?php echo ($sub_menu == 'registerreports') ? 'class="active"' : ''; ?> ><a href="<?php echo base_url(); ?>Report/registerReport"><i class="fa fa-angle-double-right"></i><?php echo lang('register_report'); ?></a></li>  

                                        <li <?php echo ($sub_menu == 'dailysummaryreports') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/dailySummaryReport"><i class="fa fa-angle-double-right"></i><?php echo lang('daily_summary_report'); ?></a></li>  

                                        <li <?php echo ($sub_menu == 'foodmenusale') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/foodMenuSales"><i class="fa fa-angle-double-right"></i><?php echo lang('food_sale_report'); ?></a></li>

                                        <li <?php echo ($sub_menu == 'daily_sale_reports') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/saleReportByDate"><i class="fa fa-angle-double-right"></i><?php echo lang('daily_sale_report'); ?></a></li> 
                                        <li <?php echo ($sub_menu == 'detailed_sale_reports') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/detailedSaleReport"><i class="fa fa-angle-double-right"></i><?php echo lang('detailed_sale_report'); ?></a></li> 
                                        <li <?php echo ($sub_menu == 'consumption_reports') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/consumptionReport"><i class="fa fa-angle-double-right"></i><?php echo lang('consumption_report'); ?></a></li>

                                        <li <?php echo ($sub_menu == 'inventory_reports') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/inventoryReport"><i class="fa fa-angle-double-right"></i><?php echo lang('inventory_report'); ?></a></li>
                                         
                                        <li <?php echo ($sub_menu == 'low_inventory_reports') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Inventory/getInventoryAlertList"><i class="fa fa-angle-double-right"></i><?php echo lang('low_inventory_report'); ?></a></li> 
                                        <li <?php echo ($sub_menu == 'profit_loss_reports') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/profitLossReport"><i class="fa fa-angle-double-right"></i><?php echo lang('profit_loss_report'); ?></a></li>
                                        <li <?php echo ($sub_menu == 'vat_reports') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/vatReport"><i class="fa fa-angle-double-right"></i><?php echo lang('vat_report'); ?></a></li> 

                                        <li <?php echo ($sub_menu == 'kitchen_performance_reports') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/kitchenPerformanceReport"><i class="fa fa-angle-double-right"></i><?php echo lang('kitchen_performance_report'); ?></a></li> 

                                        <li <?php echo ($sub_menu == 'attendance_reports') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/attendanceReport"><i class="fa fa-angle-double-right"></i><?php echo lang('attendance_report'); ?></a></li> 

                                        <li <?php echo ($sub_menu == 'supplier_ledgers') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/supplierReport"><i class="fa fa-angle-double-right"></i><?php echo lang('supplier_ledger'); ?></a></li> 

                                        <li <?php echo ($sub_menu == 'supplier_due_reports') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/supplierDueReport"><i class="fa fa-angle-double-right"></i><?php echo lang('supplier_due_report'); ?></a></li>

                                        <li <?php echo ($sub_menu == 'customer_due_report') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/customerDueReport"><i class="fa fa-angle-double-right"></i><?php echo lang('customer_due_report'); ?></a></li>

                                        <li <?php echo ($sub_menu == 'customer_ledgers') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/customerReport"><i class="fa fa-angle-double-right"></i><?php echo lang('customer_ledger'); ?></a></li> 
                                        <!-- <li><a href="<?php echo base_url(); ?>Report/saleReportByMonth"><i class="fa fa-angle-double-right"></i>Sale Report by Month</a></li>  --> 
                                        <li <?php echo ($sub_menu == 'purchase_reports') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/purchaseReportByDate"><i class="fa fa-angle-double-right"></i><?php echo lang('purchase_report'); ?></a></li> 
                                        ...
                                        <!-- <li><a href="<?php echo base_url(); ?>Report/purchaseReportByDate"><i class="fa fa-angle-double-right"></i>Pur. Report by Date</a></li> 
                                            ...
                                            <li <?php echo ($sub_menu == 'expense_reports') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/expenseReport"><i class="fa fa-angle-double-right"></i><?php echo lang('expense_report'); ?></a></li> 

                                            <li <?php echo ($sub_menu == 'waste_reports') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Report/wasteReport"><i class="fa fa-angle-double-right"></i><?php echo lang('waste_report'); ?></a></li> 
                                        </ul>
                                    </li>
                                <?php } ?>  
                                <?php if (in_array('Master', $this->session->userdata('menu_access'))) { ?> 
                                    <li class="treeview <?php echo ($master_menu == 'master') ? 'active' : ''; ?>">
                                        <a href="#">
                                        ...
                                        <ul class="treeview-menu">
                                            <li <?php echo ($sub_menu == 'ingredient_categorie') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Master/ingredientCategories"><i class="fa fa-angle-double-right"></i><?php echo lang('ingredient_categories'); ?></a></li>

                                            <li <?php echo ($sub_menu == 'ingredient_unit') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Master/Units"><i class="fa fa-angle-double-right"></i><?php echo lang('ingredient_units'); ?></a></li>

                                            <li <?php echo ($sub_menu == 'ingredient') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Master/ingredients"><i class="fa fa-angle-double-right"></i><?php echo lang('ingredients'); ?></a></li>

                                            <li <?php echo ($sub_menu == 'vat') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Master/VATs"><i class="fa fa-angle-double-right"></i><?php echo lang('vats'); ?></a></li>

                                            <li <?php echo ($sub_menu == 'modifier') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Master/modifiers"><i class="fa fa-angle-double-right"></i><?php echo lang('modifiers'); ?></a></li>

                                            <li <?php echo ($sub_menu == 'food_menu_categorie') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Master/foodMenuCategories"><i class="fa fa-angle-double-right"></i><?php echo lang('food_menu_categories'); ?></a></li>

                                            <li <?php echo ($sub_menu == 'food_menu') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Master/foodMenus"><i class="fa fa-angle-double-right"></i><?php echo lang('food_menus'); ?></a></li>

                                            <li <?php echo ($sub_menu == 'supplier') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Master/suppliers"><i class="fa fa-angle-double-right"></i><?php echo lang('suppliers'); ?></a></li>

                                            <li <?php echo ($sub_menu == 'customer') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Master/customers"><i class="fa fa-angle-double-right"></i><?php echo lang('customers'); ?></a></li> 

                                            <li <?php echo ($sub_menu == 'expense_item') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Master/expenseItems"><i class="fa fa-angle-double-right"></i><?php echo lang('expense_items'); ?></a></li>

                                            <li <?php echo ($sub_menu == 'payment_method') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Master/paymentMethods"><i class="fa fa-angle-double-right"></i><?php echo lang('payment_methods'); ?></a></li>

                                            <li <?php echo ($sub_menu == 'table') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Master/tables"><i class="fa fa-angle-double-right"></i><?php echo lang('tables'); ?></a></li> 
                                        </ul>
                                    </li>
                                <?php } ?> 
                                <li class="treeview <?php echo ($master_menu == 'setting') ? 'active' : ''; ?>">
                                    <a href="#">
                                    ...
                                    <ul class="treeview-menu"> 
                                        <li <?php echo ($sub_menu == 'general_setting') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Authentication/setting/<?php echo $this->session->userdata('company_id') ?>"><i class="fa fa-angle-double-right"></i><?php echo lang('general_settings'); ?></a></li>

                                        <li <?php echo ($sub_menu == 'sms_settings') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Authentication/SMSSetting/<?php echo $this->session->userdata('company_id') ?>"><i class="fa fa-angle-double-right"></i><?php echo lang('sms_setting'); ?></a></li>

                                        <?php if (in_array('User', $this->session->userdata('menu_access'))) { ?>  
                                            <li <?php echo ($sub_menu == 'manage_user') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>User/users"><i class="fa fa-angle-double-right"></i><?php echo lang('manage_users'); ?></a></li>

                                        <?php } ?>
                                        <li <?php echo ($sub_menu == 'change_profiles') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Authentication/changeProfile"><i class="fa fa-angle-double-right"></i><?php echo lang('change_profile'); ?></a></li>

                                        <li <?php echo ($sub_menu == 'change_passwords') ? 'class="active"' : ''; ?>><a href="<?php echo base_url(); ?>Authentication/changePassword"><i class="fa fa-angle-double-right"></i><?php echo lang('change_password'); ?></a></li>

                                        <li><a href="<?php echo base_url(); ?>Authentication/logOut"><i class="fa fa-angle-double-right"></i><?php echo lang('logout'); ?></a></li>
                                    </ul>
                                </li> 
                                   <li <?php echo ($master_menu == 'home') ? 'class="active"' : ''; ?>>
                ...
                if ($this->session->userdata('role') == 'Admin') {
                    ;
                    ?>
                    <li <?php echo ($master_menu == 'setting') ? 'class="active"' : ''; ?>>
                ...
                <footer class="main-footer">  
                    <div class="row">
                        <div class="col-md-12" style="text-align: center;">
                            <strong>Manager Of Business | PT. Kreasi Digital Indonesia</strong>
                            <div class="hidden-lg">
            ...
            <script>
                ...
                left_menu_height_should_be = (parseFloat(left_menu_height_should_be)-parseFloat(100)).toFixed(2);
